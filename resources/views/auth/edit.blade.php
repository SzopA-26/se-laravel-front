...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('แก้ไขข้อมูล') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('user.update', ['user' => $user->id]) }}" onsubmit="return confirm('ยืนยันข้อมูลทั้งหมดถูกต้อง')">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">รหัสผ่านปัจจุบัน <label class="required-red">*</label></label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="title" class="form-control @error('title') is-invalid @enderror" name="title" required autofocus>
                                        <option value="นาย"
                                        @if($user->title == 'นาย')
                                            selected
                                        @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="citizen_id" type="text" class="form-control @error('citizen_id') is-invalid @enderror" name="citizen_id" value="{{ old('citizen_id', $user->citizen_id) }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number_1" type="text" class="form-control @error('phone_number_1') is-invalid @enderror" name="phone_number_1" value="{{ old('phone_number_1', $user->phone_number_1) }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number_2" type="text" class="form-control @error('phone_number_2') is-invalid @enderror" name="phone_number_2" value="{{ old('phone_number_2', $user->phone_number_2) }}">
